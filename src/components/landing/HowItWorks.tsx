...
export default function HowItWorks() {
  return (
    <div id='works' className='mt-6 w-full overflow-hidden py-8 landing-pad'>
        <h1 className="hidden">How it Works</h1>
        <h1 className="text-center font-bold text-pro-blue text-lg mb-3">How It Works As a  Talent</h1>
        ...
        <div className="mt-16">
            <h1 className="text-center font-bold text-pro-blue text-lg mb-9">How It Works As a  Talent Seeker</h1>
